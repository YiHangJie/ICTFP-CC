    ...
    for method in methods:
        ...
        for subject in range(1, subjects + 1):
            ...
            for ws in wss:
                ...
                exp3 = Experiments(dataset, attack=attack, ws=ws, subjects=[subject], method=method, C93=True, denoise=True)
                defense_acc, defense_ITR = exp3.run()

                sub_res += [raw_acc, raw_ITR, attacked_acc, attacked_ITR, defense_acc, defense_ITR]
            res.append(sub_res)
...
# python ./Experiments/Defense_Performance_Comparison_ICTFP-CC/main.py --dataset BETA --method MSI --attack 0.3